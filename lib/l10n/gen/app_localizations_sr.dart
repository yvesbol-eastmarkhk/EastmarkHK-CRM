...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get commonUsernameLabel => 'Корисничко име';

  @override
  String get commonDisplayNameLabel => 'Приказано име';

  @override
  String get commonPasswordLabel => 'Лозинка';

  @override
  String get commonConfirmPasswordLabel => 'Потврди лозинку';

  @override
  String get commonPasswordMismatch => 'Лозинке се не подударају';

  @override
  String get commonUsernameTaken => 'Ово корисничко име је већ заузето';

  @override
  String get commonChoosePassword => 'Изаберите лозинку';

  @override
  String get commonRequiredFields => 'Име и корисничко име су обавезни';

  @override
  String get passwordFieldShow => 'Прикажи';

  @override
  String get passwordFieldHide => 'Сакриј';
  ...
  @override
  String get loginVerifying => 'Провера…';

  @override
  String get loginUnlockTouchId => 'Откључај помоћу Touch ID-а';

  @override
  String get loginOr => 'или';

  @override
  String get loginRequiredFields => 'Потребни су корисничко име и лозинка';

  @override
  String get loginInvalidCredentials => 'Погрешно корисничко име или лозинка';

  @override
  String get loginSubmit => 'Пријави се';
  ...
  @override
  String get bootstrapWelcome => 'Добродошли';

  @override
  String get bootstrapSubtitle =>
      'Направите администраторски налог да бисте заштитили свој CRM.';

  @override
  String get bootstrapSubmit => 'Направи администраторски налог';
  ...
  @override
  String get commonNotesLabel => 'Beleške';
  ...
  @override
  String get commonCompanyNameLabel => 'Naziv kompanije';
  ...
  @override
  String get messagingEmailAppLabel => 'aplikaciju za e-poštu';
  ...
  String messagingIncompleteId(String label) {
    return 'Nepotpun identifikator za otvaranje $label.';
  }

  @override
  String messagingCannotOpenApp(String label) {
    return 'Nije moguće otvoriti $label — da li je aplikacija instalirana?';
  }

  @override
  String get messagingWechatNote =>
      'WeChat ne omogućava javni link ka određenom kontaktu — aplikacija će se otvoriti, ali razgovor treba izabrati ručno.';

  @override
  String get messagingKakaotalkNote =>
      'KakaoTalk ne omogućava javni link ka određenom kontaktu — aplikacija će se otvoriti, ali razgovor treba izabrati ručno.';

  @override
  String get messagingPhoneCallLabel => 'Telefonski poziv';

  @override
  String get companyDeleteOpportunityConfirm => 'Obrisati ovu priliku?';

  @override
  String get companyDeleteContactConfirm => 'Obrisati ovaj kontakt?';

  @override
  String get companyDeleteTaskConfirm => 'Obrisati ovaj zadatak?';

  @override
  String get companyDeleteConfirmTitle => 'Obrisati ovog klijenta?';

  @override
  String companyDeleteConfirmDetail(String name) {
    return '$name — njegovi kontakti, prilike, zadaci i istorija biće obrisani zajedno s njim.';
  }

  @override
  String get companyNewNoteTitle => 'Nova beleška';

  @override
  String get companyNoteFieldLabel => 'Beleška (ili je izdiktirajte)';
  ...
  @override
  String get companyNoActivity => 'Nema aktivnosti — dodajte belešku.';
  ...
  @override
  String get companyNoteButtonLabel => 'Beleška';

  @override
  String get companyNewClientTitle => 'Novi klijent';

  @override
  String get companyEditClientTitle => 'Izmeni klijenta';

  @override
  String get companyWebsiteLabel => 'Veb-sajt';
  ...
  @override
  String get companyEditContactTitle => 'Izmeni kontakt';
  ...
  String get companyNoMessagingHint =>
      'Nije dodat kanal za poruke — WhatsApp, WeChat, iMessage…';

  @override
  String get companyNoContactInfo =>
      'Još uvek nema dodatih podataka za kontakt.';

  @override
  String get settingsTitle => 'Podešavanja';

  @override
  String get settingsSubtitle => 'Jednokratno podešavanje aplikacije.';
  ...
  String get settingsFormatsHint =>
      'Iznosi se prikazuju kao 1.234,56 (tačka = hiljade, zarez = decimale), a datumi kao dd.mm.gggg, bez obzira na jezik interfejsa.';

  @override
  String get settingsCompanyTitle => 'Kompanija';

  @override
  String get settingsCompanySubtitle =>
      'Identitet kompanije koja koristi ovaj CRM — kasnije se koristi u zaglavlju (white-label) i zaglavljima PDF dokumenata.';

  @override
  String get settingsSyncTitle => 'Sinhronizacija';

  @override
  String get settingsSyncSubtitle =>
      'Podrazumevano, svi podaci ostaju lokalno (SQLite) na ovom uređaju.';
  ...
  @override
  String get settingsSyncRemoteTitle => 'Deljena baza podataka (udaljena)';

  @override
  String get settingsSyncRemoteSubtitle =>
      'Sinhronizuje se sa PHP + SQLite serverom (vidi server/crm-sync/)';

  @override
  String get settingsServerLabel => 'Server';

  @override
  String get settingsAccountLabel => 'Nalog';

  @override
  String get settingsSyncPasswordHint =>
      'Sačuvano u bezbednom privesku ključeva uređaja — nikada u bazi podataka.';

  @override
  String get settingsSyncNowButton => 'Sinhronizuj sada';

  @override
  String get settingsSyncPollHint =>
      'Automatsko preuzimanje na svakih 25 s u pozadini; trenutno slanje nakon svake izmene (aktivan udaljeni režim). Nema preuzimanja tokom kucanja.';

  @override
  String get settingsSyncMissingFields => 'Potrebni su server, nalog i lozinka';
  ...
  String get settingsModulesSubtitle =>
      'EastmarkHK e-Invoicing, skener, sinhronizacija… — 7-dnevni probni period ili aktivacija licence.';
  ...
  @override
  String get settingsConfigureStages => 'Podesi faze';

  @override
  String get settingsBackupTitle => 'Lokalna rezervna kopija';

  @override
  String get settingsBackupSubtitle =>
      'Izvozi kopiju vaše SQLite baze podataka — korisno pre ažuriranja ili za arhiviranje.';

  @override
  String get settingsExportDbButton => 'Izvezi bazu podataka (.db)';

  @override
  String get settingsBackupShareText => 'Rezervna kopija EastmarkHK CRM';
  ...
  String get settingsUsersSubtitleAdmin =>
      'Nalozi, uloge i lozinke — administrator i korisnik.';
  ...
  String get settingsUsersLockedHint =>
      'Prijavite se administratorskim nalogom da biste videli ili izmenili korisnike i njihove lozinke.';

  @override
  String get settingsSaveKeychainError =>
      'Podešavanja sačuvana, ali bezbedni privezak ključeva nije dostupan — lozinku za sinhronizaciju nije bilo moguće sačuvati (ponovo pokrenite aplikaciju nakon potpune ponovne izgradnje).';
  ...
  String get settingsLogoutConfirmDetail =>
      'Za povratak ćete morati da unesete lozinku (ili Touch ID).';

  @override
  String get settingsLogoutButton => 'Odjava';

  @override
  String get settingsLogoTitle => 'Logo kompanije';

  @override
  String get settingsLogoSubtitle =>
      'Prikazuje se na vrhu aplikacije i u baneru.';

  @override
  String get settingsLogoEmpty =>
      'Nema logotipa — dodajte logotip svoje kompanije';

  @override
  String get settingsLogoChoose => 'Izaberi sliku';

  @override
  String get settingsLogoChange => 'Promeni logotip';

  @override
  String get usersDeleteSelfError => 'Ne možete obrisati sopstveni nalog';

  @override
  String get usersDeleteConfirmTitle => 'Obrisati ovog korisnika?';

  @override
  String usersDeleteConfirmDetail(String displayName, String username) {
    return '$displayName ($username) izgubiće pristup CRM-u.';
  }
  ...
  @override
  String get usersSubtitle => 'Nalozi, uloge i lozinke.';
  ...
  @override
  String get usersEmptySubtitle => 'Kreirajte prvi nalog — biće administrator.';
  ...
  @override
  String get usersEditTitle => 'Izmeni korisnika';
  ...
  String get usersNewPasswordLabel =>
      'Nova lozinka (ostavite prazno da se ne menja)';
  ...
  @override
  String get dashboardTitleEmbedded => 'Kontrolna tabla';
  ...
  @override
  String get dashboardAllReps => 'Svi prodavci';
  ...
  String get dashboardNothingScheduled =>
      'Ništa nije zakazano — vaše naknadne radnje pojaviće se ovde.';

  @override
  String get dashboardBucketOverdue => 'Zakasnelo';

  @override
  String get dashboardBucketToday => 'Danas';

  @override
  String get dashboardBucketWeek => 'Ove nedelje';
  ...
  @override
  String get dashboardTopClients => 'Najbolji klijenti (otvoren pipeline)';
  ...
  @override
  String get dashboardWonLostByMonth => 'Dobijeno / izgubljeno po mesecu';

  @override
  String get dashboardNoClosuresYet => 'Još nema zabeleženih zatvaranja.';
  ...
  @override
  String get metricOverdue => 'Zakasnelo';

  @override
  String get productTagline => 'Uštedite vreme od prvog dana.';
  ...
  String get placeholderTodayHint =>
      'Izaberite naknadnu radnju levo.\nKlijent se otvara ovde — bez promene ekrana.';
  ...
  String get placeholderClientsHint =>
      'Izaberite klijenta sa liste\nili kreirajte novog dugmetom +.';

  @override
  String get placeholderPipelineHint =>
      'Prevucite karticu između kolona.\nKliknite da otvorite karticu klijenta.';

  @override
  String get placeholderTasksHint =>
      'Izaberite zadatak da vidite povezanog klijenta.';

  @override
  String get modulesSubtitleAppStore =>
      'Претплатите се преко App Store-а или активирајте претплату већ купљену на eastmarkhk.com.';

  @override
  String get modulesSubtitleWebStore =>
      'Бесплатна проба, куповина на eastmarkhk.com — иста претплата као у апликацији EastmarkHK e-Invoicing.';
  ...
  String modulesStatusTrial(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Проба — остало $countString дана',
      few: 'Проба — остала $countString дана',
      one: 'Проба — остао $countString дан',
    );
    return '$_temp0';
  }
  ...
  String get modulesBuyFailed =>
      'Куповина није могла да се покрене. Покушајте поново или вратите своје куповине.';

  @override
  String get modulesRestoreDone => 'Враћање је завршено.';

  @override
  String modulesImportedFromEinvoicing(String name) {
    return '$name је активиран из инсталиране апликације.';
  }

  @override
  String get modulesLicenseNotFound =>
      'Лиценца није аутоматски пронађена. Отворите EastmarkHK e-Invoicing → Подешавања, копирајте активациони код и изаберите „Активирај веб код“.';

  @override
  String get modulesRenewalNote =>
      'Аутоматско обнављање преко App Store-а. Управљајте претплатом у Подешавања → Apple ID → Претплате.';

  @override
  String get modulesWebStoreNote =>
      'Или се претплатите на eastmarkhk.com и активирајте кодом примљеним е-поштом.';

  @override
  String get modulesHaveEinvoicing => 'Већ имам EastmarkHK e-Invoicing';

  @override
  String get modulesTry7Days => 'Испробајте 7 дана';

  @override
  String get modulesSubscribe => 'Претплатите се';

  @override
  String get modulesRestore => 'Врати куповине';

  @override
  String get modulesWebSubscription => 'Претплата eastmarkhk.com';

  @override
  String get modulesActivateWebCode => 'Активирај веб код';

  @override
  String get modulesUseInCrm => 'Користи у CRM-у';

  @override
  String get modulesDontUseInCrm => 'Не користити у CRM-у';

  @override
  String get modulesBuyOnAppStore => 'Купи на App Store-у';

  @override
  String get modulesStoreUnavailable =>
      'App Store није доступан у овој верзији. Користите верзију за App Store, или активирајте претплату на eastmarkhk.com.';

  @override
  String get modulesCheckingPurchases =>
      'Проверавају се куповине са App Store-а и eastmarkhk.com…';

  @override
  String get modulesCheckingAppStore =>
      'Проверавају се куповине са App Store-а…';
  ...
  String get modulesActivationSubtitleAppStore =>
      'Да ли сте се претплатили на eastmarkhk.com? Налепите код примљен е-поштом. На iPhone/iPad-у почетна куповина се обавља преко App Store-а или сајта пре активације.';

  @override
  String get modulesActivationSubtitleWeb =>
      'Претплатите се на eastmarkhk.com, затим налепите активациони код повезан са овим уређајем.';

  @override
  String get modulesMachineId => 'ИД уређаја';

  @override
  String get modulesCopy => 'Копирај';

  @override
  String get modulesSubscriptionEmailLabel => 'Е-пошта претплате';

  @override
  String get modulesActivationCodeLabel => 'Активациони код';

  @override
  String get modulesActivationCodeHint => 'Налепите код примљен након куповине';

  @override
  String get modulesActivate => 'Активирај';

  @override
  String get modulesBuyOnWebsite => 'Купи на eastmarkhk.com';

  @override
  String get modulesRequestCodeByEmail => 'Затражи код е-поштом';

  @override
  String modulesActivatedViaWebsite(String name) {
    return '$name је активиран преко eastmarkhk.com';
  }

  @override
  String get modulesMachineIdCopied => 'ИД уређаја копиран';

  @override
  String get modulesEmailRequired => 'Унесите своју е-пошту претплате';
  ...
  @override
  String get invPickClientTitle => 'Изабери клијента';

  @override
  String get invPickClientSearch => 'Претражи по имену, ПИБ-у, држави…';

  @override
  String get invPickClientEmpty => 'Нема одговарајућег клијента.';

  @override
  String get invPickClientButton => 'Изабери клијента';

  @override
  String get invClientRequired => 'Изаберите клијента пре чувања.';
  ...
  @override
  String get invSave => 'Сачувај';

  @override
  String get invSaving => 'Чување…';

  @override
  String invEditQuote(String number) {
    return 'Уреди понуду $number';
  }

  @override
  String invEditInvoice(String number) {
    return 'Уреди фактуру $number';
  }

  @override
  String invDocumentSaved(String number) {
    return '$number сачувано.';
  }
  ...
  @override
  String get invEditDocument => 'Уреди';
  ...
  String get invHomeSubtitle =>
      'Понуде и фактуре — подаци из EastmarkHK e-Invoicing (признанице и подсетници: самостална апликација)';

  @override
  String get invOpenStandalone => 'Отвори e-Invoicing';

  @override
  String get invLaunchStandalone => 'Покрени e-Invoicing';

  @override
  String get invRemoteConnectionTooltip => 'Удаљена веза';
  ...
  String invTabInvoices(int count) {
    return 'Фактуре ($count)';
  }

  @override
  String get invEmptyQuotes =>
      'Нема понуда — направите једну из добијене прилике или дугметом изнад.';

  @override
  String get invEmptyInvoices => 'Нема фактура.';

  @override
  String get invEmptyCompanyDocs => 'Нема понуда ни фактура.';

  @override
  String get invQuotesSection => 'ПОНУДЕ';

  @override
  String get invInvoicesSection => 'ФАКТУРЕ';

  @override
  String get invCompanyFooter =>
      'Документима управља EastmarkHK e-Invoicing — слање, PDF, признанице и подсетници у самосталној апликацији.';

  @override
  String get invRemoteNotConfigured =>
      'e-Invoicing је у удаљеном режиму — веза није конфигурисана.';

  @override
  String get invConfigure => 'Конфигуриши';

  @override
  String get invAppNotDetected =>
      'Апликација e-Invoicing није откривена — инсталирајте/покрените EastmarkHK e-Invoicing да бисте направили понуде и фактуре из овог записа.';

  @override
  String get invRemoteSetupBody =>
      'EastmarkHK e-Invoicing је конфигурисана за удаљено складиштење. Унесите овде исте акредитиве да повежете CRM на исти API — исте вредности као у e-Invoicing → Подешавања → Удаљено складиштење.';

  @override
  String get invLaunchOnceBody =>
      'Покрените EastmarkHK e-Invoicing једном да иницијализујете дељену базу података, а затим се вратите овде.';

  @override
  String get invAcquireAppStoreBody =>
      'Овај модул користи EastmarkHK e-Invoicing. Преузмите и претплатите се преко App Store-а, покрените је једном, а затим се вратите овде.';

  @override
  String get invAcquireWebBody =>
      'Овај модул користи EastmarkHK e-Invoicing. Преузмите и претплатите се на eastmarkhk.com, покрените је једном, а затим се вратите овде.';

  @override
  String get invConfigureRemote => 'Конфигуриши удаљену везу';

  @override
  String get invViewOnAppStore => 'Погледај на App Store-у';

  @override
  String get invViewOnWebsite => 'Погледај на eastmarkhk.com';

  @override
  String get invRetry => 'Покушај поново';

  @override
  String get invDocInvoice => 'Фактура';

  @override
  String get invDocQuote => 'Понуда';

  @override
  String get invDocClient => 'Клијент';

  @override
  String get invDocStatus => 'Статус';

  @override
  String get invDocDate => 'Датум';

  @override
  String get invOpenInStandalone => 'Отвори у e-Invoicing';

  @override
  String get invOpenStandaloneFailed =>
      'e-Invoicing није могао да се отвори — проверите да ли је инсталиран.';

  @override
  String get invCreateInvoiceFromQuote => 'Направи фактуру';

  @override
  String get invCreatingInvoice => 'Прављење фактуре…';

  @override
  String invInvoiceCreatedFromQuote(String number) {
    return 'Фактура $number направљена из понуде.';
  }

  @override
  String get invQuoteAlreadyInvoiced => 'За ову понуду је већ издата фактура.';

  @override
  String invCreateInvoiceFailed(String error) {
    return 'Фактуру није могуће направити: $error';
  }

  @override
  String get invLinkMenu => 'Веза са e-Invoicing';

  @override
  String get invLinkStatusLinked => 'Клијент e-Invoicing повезан';

  @override
  String get invLinkStatusNone => 'Нема сачуване везе са e-Invoicing';

  @override
  String get invUnlinkCustomer => 'Прекини везу са клијентом e-Invoicing';

  @override
  String get invUnlinkConfirmTitle => 'Прекинути везу са клијентом?';

  @override
  String get invUnlinkConfirmBody =>
      'Следећа понуда или фактура ће поново тражити да изаберете или направите клијента у e-Invoicing.';

  @override
  String get invUnlinkDone => 'Веза са e-Invoicing уклоњена.';

  @override
  String get invAppStoreUrlMissing =>
      'e-Invoicing још увек није наведен на App Store-у за ову верзију. Користите eastmarkhk.com или покрените већ инсталирану апликацију.';
  ...
  String get shellSyncNeedsPassword =>
      'Дељена база података: унесите лозинку за синхронизацију у Подешавањима да бисте поново повезали овај уређај.';
