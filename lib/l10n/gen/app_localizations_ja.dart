...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get commonUsernameLabel => 'ユーザー名';

  @override
  String get commonDisplayNameLabel => '表示名';

  @override
  String get commonPasswordLabel => 'パスワード';

  @override
  String get commonConfirmPasswordLabel => 'パスワードの確認';

  @override
  String get commonPasswordMismatch => 'パスワードが一致しません';

  @override
  String get commonUsernameTaken => 'このユーザー名は既に使用されています';

  @override
  String get commonChoosePassword => 'パスワードを設定してください';

  @override
  String get commonRequiredFields => '名前とユーザー名は必須です';

  @override
  String get passwordFieldShow => '表示';

  @override
  String get passwordFieldHide => '非表示';
  ...
  @override
  String get loginVerifying => '確認中…';

  @override
  String get loginUnlockTouchId => 'Touch IDでロック解除';

  @override
  String get loginOr => 'または';

  @override
  String get loginRequiredFields => 'ユーザー名とパスワードが必要です';
  ...
  @override
  String get bootstrapWelcome => 'ようこそ';

  @override
  String get bootstrapSubtitle => 'CRMを保護するために管理者アカウントを作成してください。';

  @override
  String get bootstrapSubmit => '管理者アカウントを作成';
  ...
  @override
  String get commonNoName => '(名前なし)';

  @override
  String get commonNotesLabel => 'メモ';

  @override
  String get commonEmailLabel => 'メール';

  @override
  String get commonPhoneLabel => '電話';

  @override
  String get commonFirstNameLabel => '名';

  @override
  String get commonLastNameLabel => '姓';

  @override
  String get commonCompanyNameLabel => '会社名';

  @override
  String messagingCannotOpen(String target) {
    return '$target を開けません。';
  }

  @override
  String get messagingEmailAppLabel => 'メールアプリ';

  @override
  String get messagingPhoneAppLabel => '電話アプリ';

  @override
  String messagingIncompleteId(String label) {
    return '$label を開くための識別子が不完全です。';
  }

  @override
  String messagingCannotOpenApp(String label) {
    return '$label を開けません — アプリはインストールされていますか？';
  }

  @override
  String get messagingWechatNote =>
      'WeChat は特定の連絡先への公開リンクを提供していません — アプリは開きますが、会話は手動で選択する必要があります。';

  @override
  String get messagingKakaotalkNote =>
      'KakaoTalk は特定の連絡先への公開リンクを提供していません — アプリは開きますが、会話は手動で選択する必要があります。';

  @override
  String get messagingPhoneCallLabel => '電話をかける';

  @override
  String get companyDeleteOpportunityConfirm => 'この商談を削除しますか？';

  @override
  String get companyDeleteContactConfirm => 'この連絡先を削除しますか？';

  @override
  String get companyDeleteTaskConfirm => 'このタスクを削除しますか？';

  @override
  String get companyDeleteConfirmTitle => 'この顧客を削除しますか？';

  @override
  String companyDeleteConfirmDetail(String name) {
    return '$name — 連絡先、商談、タスク、履歴もすべて削除されます。';
  }

  @override
  String get companyNewNoteTitle => '新しいメモ';

  @override
  String get companyNoteFieldLabel => 'メモ（または口述）';

  @override
  String get companyTabOverview => '概要';

  @override
  String get companyTabActivity => '活動';

  @override
  String get companyTabTasks => 'タスク';

  @override
  String get companyTabDeals => '商談';

  @override
  String get companyContactsTitle => '連絡先';

  @override
  String get companyNoContacts => '連絡先なし';

  @override
  String get companyNoActivity => '活動なし — メモを追加してください。';

  @override
  String get companyNoTasks => 'タスクなし';

  @override
  String get companyNoDeals => '商談なし';

  @override
  String get companyNoteButtonLabel => 'メモ';

  @override
  String get companyNewClientTitle => '新規顧客';

  @override
  String get companyEditClientTitle => '顧客を編集';

  @override
  String get companyWebsiteLabel => 'ウェブサイト';
  ...
  @override
  String get companyTagsLabel => 'タグ（カンマ区切り）';

  @override
  String get companyNewContactTitle => '新規連絡先';

  @override
  String get companyEditContactTitle => '連絡先を編集';

  @override
  String get companyAppLabel => 'アプリ';

  @override
  String get companyIdentifierNumberLabel => '識別子／番号';

  @override
  String get companyOpenTooltip => '開く';

  @override
  String get companyRemoveTooltip => '削除';

  @override
  String get companyRoleFieldLabel => '役職（例：購買担当）';

  @override
  String get companyMessagingTitle => 'メッセージング';

  @override
  String get companyNoMessagingHint =>
      'メッセージングチャンネルが未追加です — WhatsApp、WeChat、iMessage…';

  @override
  String get companyNoContactInfo => '連絡先情報がまだありません。';

  @override
  String get settingsTitle => '設定';

  @override
  String get settingsSubtitle => 'アプリの初期設定です。';

  @override
  String get settingsLanguagesTitle => '言語と通貨';

  @override
  String get settingsAppLanguageLabel => 'アプリの言語';

  @override
  String get settingsDictationLanguageLabel => '音声入力の言語';

  @override
  String get settingsCurrencyLabel => '通貨';

  @override
  String get settingsFormatsHint =>
      '金額は 1,234.56（カンマ＝千位、ピリオド＝小数）、日付は dd/mm/yyyy 形式で表示されます（インターフェース言語に関係なく）。';

  @override
  String get settingsCompanyTitle => '会社';

  @override
  String get settingsCompanySubtitle =>
      'この CRM を使用する会社情報 — 後でヘッダー（ホワイトラベル）や PDF 文書のヘッダーに再利用されます。';

  @override
  String get settingsSyncTitle => '同期';

  @override
  String get settingsSyncSubtitle =>
      'デフォルトでは、すべてのデータはこのデバイス上にローカル（SQLite）で保存されます。';

  @override
  String get settingsSyncLocalTitle => 'スタンドアロン（ローカルのみ）';

  @override
  String get settingsSyncLocalSubtitle => 'このデバイス外へデータは送信されません';

  @override
  String get settingsSyncRemoteTitle => '共有データベース（リモート）';

  @override
  String get settingsSyncRemoteSubtitle =>
      'PHP + SQLite サーバーと同期します（server/crm-sync/ 参照）';

  @override
  String get settingsServerLabel => 'サーバー';

  @override
  String get settingsAccountLabel => 'アカウント';

  @override
  String get settingsSyncPasswordHint =>
      'デバイスの安全なキーチェーンに保存されます — データベースには保存されません。';

  @override
  String get settingsSyncNowButton => '今すぐ同期';

  @override
  String get settingsSyncPollHint =>
      'バックグラウンドで25秒ごとに自動取得。変更ごとに即時プッシュ（リモートモード有効時）。入力中は取得しません。';

  @override
  String get settingsSyncMissingFields => 'サーバー、アカウント、パスワードが必要です';

  @override
  String get settingsModulesTitle => 'モジュール';

  @override
  String get settingsModulesSubtitle =>
      'EastmarkHK e-Invoicing、スキャナー、同期… — 7日間の試用またはライセンス有効化。';

  @override
  String get settingsBrowseModules => 'モジュールを見る';

  @override
  String get settingsImportExportTitle => 'インポート／エクスポート';

  @override
  String get settingsImportExportSubtitle => '顧客、連絡先、商談を CSV で。連絡先は vCard から。';

  @override
  String get settingsPipelineTitle => 'パイプライン';

  @override
  String get settingsPipelineSubtitle => 'ステージとそのラベルをカスタマイズします。';

  @override
  String get settingsConfigureStages => 'ステージを設定';

  @override
  String get settingsBackupTitle => 'ローカルバックアップ';

  @override
  String get settingsBackupSubtitle =>
      'SQLite データベースのコピーをエクスポートします — 更新前やアーカイブに便利です。';

  @override
  String get settingsExportDbButton => 'データベースをエクスポート（.db）';

  @override
  String get settingsBackupShareText => 'EastmarkHK CRM バックアップ';
  ...
  @override
  String get settingsUsersTitle => 'ユーザー';

  @override
  String get settingsUsersSubtitleAdmin => 'アカウント、ロール、パスワード — 管理者とユーザー。';

  @override
  String get settingsUsersSubtitleLocked => '管理者のみ。';

  @override
  String get settingsManageUsersButton => 'ユーザーを管理';

  @override
  String get settingsUsersLockedHint =>
      'ユーザーとそのパスワードを表示・編集するには、管理者アカウントでログインしてください。';

  @override
  String get settingsSaveKeychainError =>
      '設定は保存されましたが、安全なキーチェーンが利用できません — 同期パスワードを保存できませんでした（完全な再ビルド後にアプリを再起動してください）。';

  @override
  String get settingsSaved => '設定を保存しました';

  @override
  String get settingsLogoutConfirmTitle => 'サインアウトしますか？';

  @override
  String get settingsLogoutConfirmDetail => '戻るにはパスワード（または Touch ID）の入力が必要です。';

  @override
  String get settingsLogoutButton => 'サインアウト';

  @override
  String get settingsLogoTitle => '会社ロゴ';

  @override
  String get settingsLogoSubtitle => 'アプリ上部とバナーに表示されます。';

  @override
  String get settingsLogoEmpty => 'ロゴなし — 会社のロゴを追加してください';

  @override
  String get settingsLogoChoose => '画像を選択';

  @override
  String get settingsLogoChange => 'ロゴを変更';

  @override
  String get usersDeleteSelfError => '自分自身のアカウントは削除できません';

  @override
  String get usersDeleteConfirmTitle => 'このユーザーを削除しますか？';

  @override
  String usersDeleteConfirmDetail(String displayName, String username) {
    return '$displayName（$username）は CRM へのアクセス権を失います。';
  }

  @override
  String get usersTitle => 'ユーザー';

  @override
  String get usersSubtitle => 'アカウント、ロール、パスワード。';

  @override
  String get usersAddButton => 'ユーザー';

  @override
  String get usersEmptyTitle => 'ユーザーなし';

  @override
  String get usersEmptySubtitle => '最初のアカウントを作成してください — 管理者になります。';

  @override
  String get usersEmptyAction => '新規ユーザー';
  ...
  @override
  String get usersNewTitle => '新規ユーザー';

  @override
  String get usersEditTitle => 'ユーザーを編集';

  @override
  String get usersLoginIdLabel => 'ログインID';

  @override
  String get usersRoleLabel => 'ロール';

  @override
  String get usersNewPasswordLabel => '新しいパスワード（変更しない場合は空欄のまま）';

  @override
  String get usersTouchIdTitle => 'このデバイスの Touch ID';

  @override
  String get usersTouchIdSubtitle => 'パスワードを再入力せずに解除（このデバイスのみ）。';

  @override
  String get roleAdministrator => '管理者';

  @override
  String get roleUser => 'ユーザー';

  @override
  String get dashboardTitleEmbedded => 'ダッシュボード';

  @override
  String get dashboardTitle => '今日';
  ...
  String dashboardActionsToProcess(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '処理待ちのアクション $countString 件',
    );
    return '$_temp0';
  }
  ...
  String dashboardMoreAgendaItems(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '他 $countString 件 — すべて見る',
    );
    return '$_temp0';
  }

  @override
  String get dashboardAllReps => 'すべての担当者';
  ...
  @override
  String get dashboardEmptyTitle => 'CRM の準備ができました';

  @override
  String get dashboardEmptySubtitle =>
      '最初の顧客を追加するか、CSV ファイルをインポートするか、今後のモジュールをご覧ください。';

  @override
  String get dashboardNothingScheduled => '予定なし — フォローアップはここに表示されます。';

  @override
  String get dashboardBucketOverdue => '期限超過';

  @override
  String get dashboardBucketToday => '今日';

  @override
  String get dashboardBucketWeek => '今週';

  @override
  String get dashboardBucketLater => '後で';

  @override
  String get dashboardContactedButton => '連絡済み';

  @override
  String get dashboardDoneButton => '完了';
  ...
  @override
  String get dashboardTopClients => '主要顧客（進行中のパイプライン）';

  @override
  String get dashboardPipelineByStage => 'ステージ別パイプライン';

  @override
  String get dashboardNoOpportunitiesYet => '商談はまだありません';

  @override
  String get dashboardWonLostByMonth => '月別の成約／失注';

  @override
  String get dashboardNoClosuresYet => 'まだクローズが記録されていません。';

  @override
  String get dashboardRecentActivity => '最近の活動';

  @override
  String get dashboardNoActivityYet => 'まだ活動がありません。';

  @override
  String get metricClients => '顧客';

  @override
  String get metricOpportunities => '商談';

  @override
  String get metricPipeline => 'パイプライン';

  @override
  String get metricForecast => '予測';

  @override
  String get metricTasks => 'タスク';

  @override
  String get metricOverdue => '期限超過';

  @override
  String get productTagline => '初日から時間を節約。';

  @override
  String get placeholderDashboardHint => '概要：パイプライン、フォローアップ、最近の活動。';

  @override
  String get placeholderTodayTitle => 'あなたの一日';

  @override
  String get placeholderTodayHint =>
      '左からフォローアップを選択してください。\n顧客情報はここに表示されます — 画面を切り替えずに。';

  @override
  String get placeholderClientsTitle => '顧客カード';

  @override
  String get placeholderClientsHint => 'リストから顧客を選択するか、\n+ ボタンで新規作成してください。';

  @override
  String get placeholderPipelineHint => 'カードを列間でドラッグしてください。\nクリックで顧客カードを開きます。';

  @override
  String get placeholderTasksHint => 'タスクを選択すると関連する顧客が表示されます。';

  @override
  String get modulesSubtitleAppStore =>
      'App Store で購読するか、eastmarkhk.com で購入済みのサブスクリプションを有効にしてください。';

  @override
  String get modulesSubtitleWebStore =>
      '無料トライアル、eastmarkhk.com で購入 — EastmarkHK e-Invoicing アプリと同じサブスクリプション。';

  @override
  String get modulesStatusActiveAppStore => '有効 — App Store';

  @override
  String get modulesStatusActiveWeb => '有効 — eastmarkhk.com';
  ...
  String modulesStatusTrial(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'トライアル — 残り $countString 日',
    );
    return '$_temp0';
  }

  @override
  String get modulesStatusActive => '有効';

  @override
  String get modulesStatusAvailable => '利用可能';

  @override
  String get modulesBuyFailed => '購入を開始できませんでした。もう一度お試しになるか、購入を復元してください。';

  @override
  String get modulesRestoreDone => '復元が完了しました。';

  @override
  String modulesImportedFromEinvoicing(String name) {
    return '$name をインストール済みのアプリから有効にしました。';
  }

  @override
  String get modulesLicenseNotFound =>
      'ライセンスが自動的に見つかりませんでした。EastmarkHK e-Invoicing → 設定 を開き、アクティベーションコードをコピーして「Webコードを有効化」を選択してください。';

  @override
  String get modulesRenewalNote =>
      'App Store 経由で自動更新されます。サブスクリプションは 設定 → Apple ID → サブスクリプション で管理できます。';

  @override
  String get modulesWebStoreNote =>
      'または eastmarkhk.com で購読し、メールで受け取ったコードで有効化してください。';

  @override
  String get modulesHaveEinvoicing => 'EastmarkHK e-Invoicing をすでに持っています';

  @override
  String get modulesTry7Days => '7日間試す';

  @override
  String get modulesSubscribe => '購読する';

  @override
  String get modulesRestore => '購入を復元';

  @override
  String get modulesWebSubscription => 'eastmarkhk.com サブスクリプション';

  @override
  String get modulesActivateWebCode => 'Webコードを有効化';

  @override
  String get modulesUseInCrm => 'CRMで使用';

  @override
  String get modulesDontUseInCrm => 'CRMで使用しない';

  @override
  String get modulesBuyOnAppStore => 'App Storeで購入';

  @override
  String get modulesStoreUnavailable =>
      'このビルドではApp Storeを利用できません。App Store版を使用するか、eastmarkhk.comのサブスクリプションを有効にしてください。';

  @override
  String get modulesCheckingPurchases => 'App Storeとeastmarkhk.comの購入を確認しています…';

  @override
  String get modulesCheckingAppStore => 'App Storeの購入を確認しています…';
  ...
  String get modulesActivationSubtitleAppStore =>
      'eastmarkhk.com で購読しましたか？ メールで受け取ったコードを貼り付けてください。iPhone/iPad では、有効化の前に App Store またはサイトで初回購入が行われます。';

  @override
  String get modulesActivationSubtitleWeb =>
      'eastmarkhk.com で購読し、このデバイスにリンクされたアクティベーションコードを貼り付けてください。';

  @override
  String get modulesMachineId => 'マシン ID';

  @override
  String get modulesCopy => 'コピー';

  @override
  String get modulesSubscriptionEmailLabel => '購読メールアドレス';

  @override
  String get modulesActivationCodeLabel => 'アクティベーションコード';

  @override
  String get modulesActivationCodeHint => '購入後に受け取ったコードを貼り付け';

  @override
  String get modulesActivate => '有効化';

  @override
  String get modulesBuyOnWebsite => 'eastmarkhk.com で購入';

  @override
  String get modulesRequestCodeByEmail => 'メールでコードをリクエスト';

  @override
  String modulesActivatedViaWebsite(String name) {
    return '$name を eastmarkhk.com 経由で有効化しました';
  }

  @override
  String get modulesMachineIdCopied => 'マシン ID をコピーしました';

  @override
  String get modulesEmailRequired => '購読メールアドレスを入力してください';
  ...
  @override
  String get invPickClientTitle => '顧客を選択';

  @override
  String get invPickClientSearch => '名前、税番号、国で検索…';

  @override
  String get invPickClientEmpty => '該当する顧客がいません。';

  @override
  String get invPickClientButton => '顧客を選択';

  @override
  String get invClientRequired => '保存する前に顧客を選択してください。';
  ...
  String get invHomeSubtitle =>
      '見積書と請求書 — EastmarkHK e-Invoicingのデータ（受領と催促はスタンドアロンアプリで）';

  @override
  String get invOpenStandalone => 'e-Invoicingを開く';

  @override
  String get invLaunchStandalone => 'e-Invoicingを起動';

  @override
  String get invRemoteConnectionTooltip => 'リモート接続';
  ...
  @override
  String get invEmptyQuotes => '見積書がありません — 受注した案件、または上のボタンから作成してください。';

  @override
  String get invEmptyInvoices => '請求書がありません。';

  @override
  String get invEmptyCompanyDocs => '見積書も請求書もありません。';

  @override
  String get invQuotesSection => '見積書';

  @override
  String get invInvoicesSection => '請求書';

  @override
  String get invCompanyFooter =>
      '書類はEastmarkHK e-Invoicingで管理されます — 送信、PDF、受領、催促はスタンドアロンアプリで行います。';

  @override
  String get invRemoteNotConfigured => 'e-Invoicingはリモートモードです — 接続が設定されていません。';

  @override
  String get invConfigure => '設定';

  @override
  String get invAppNotDetected =>
      'e-Invoicingアプリが検出されません — このレコードから見積書や請求書を作成するには、EastmarkHK e-Invoicingをインストール・起動してください。';

  @override
  String get invRemoteSetupBody =>
      'EastmarkHK e-Invoicingはリモートストレージに設定されています。CRMを同じAPIに接続するには、ここに同じ認証情報を入力してください — e-Invoicing→設定→リモートストレージと同じ値です。';

  @override
  String get invLaunchOnceBody =>
      '共有データベースを初期化するため、一度EastmarkHK e-Invoicingを起動してから、ここに戻ってください。';

  @override
  String get invAcquireAppStoreBody =>
      'このモジュールはEastmarkHK e-Invoicingを使用します。App Storeからダウンロードして購読し、一度起動してからここに戻ってください。';

  @override
  String get invAcquireWebBody =>
      'このモジュールはEastmarkHK e-Invoicingを使用します。eastmarkhk.comでダウンロードして購読し、一度起動してからここに戻ってください。';

  @override
  String get invConfigureRemote => 'リモート接続を設定';

  @override
  String get invViewOnAppStore => 'App Storeで見る';

  @override
  String get invViewOnWebsite => 'eastmarkhk.comで見る';

  @override
  String get invRetry => '再試行';

  @override
  String get invDocInvoice => '請求書';

  @override
  String get invDocQuote => '見積書';

  @override
  String get invDocClient => '顧客';

  @override
  String get invDocStatus => 'ステータス';

  @override
  String get invDocDate => '日付';

  @override
  String get invOpenInStandalone => 'e-Invoicingで開く';

  @override
  String get invOpenStandaloneFailed =>
      'e-Invoicingを開けませんでした — インストールされているか確認してください。';

  @override
  String get invCreateInvoiceFromQuote => '請求書を作成';

  @override
  String get invCreatingInvoice => '請求書を作成中…';

  @override
  String invInvoiceCreatedFromQuote(String number) {
    return '見積書から請求書 $number を作成しました。';
  }

  @override
  String get invQuoteAlreadyInvoiced => 'この見積書はすでに請求済みです。';

  @override
  String invCreateInvoiceFailed(String error) {
    return '請求書を作成できませんでした：$error';
  }

  @override
  String get invLinkMenu => 'e-Invoicingリンク';

  @override
  String get invLinkStatusLinked => 'e-Invoicingの顧客がリンクされています';

  @override
  String get invLinkStatusNone => '保存されたe-Invoicingリンクはありません';

  @override
  String get invUnlinkCustomer => 'e-Invoicingの顧客リンクを解除';

  @override
  String get invUnlinkConfirmTitle => '顧客のリンクを解除しますか？';

  @override
  String get invUnlinkConfirmBody =>
      '次回の見積書または請求書作成時に、e-Invoicingで顧客を再度選択または作成するよう求められます。';

  @override
  String get invUnlinkDone => 'e-Invoicingリンクを解除しました。';

  @override
  String get invAppStoreUrlMissing =>
      'このビルドではe-InvoicingはまだApp Storeに掲載されていません。eastmarkhk.comを使用するか、既にインストール済みのアプリを起動してください。';
  ...
  String get shellSyncNeedsPassword =>
      '共有データベース：このデバイスを再接続するには、設定で同期パスワードを入力してください。';
